 ...
 *******************************************************************/
/*
<applet code="GalacticWar.class" height="600" width="800"></applet>
*/
 import java.awt.*;
...
public class GalacticWar extends Game {
    ...
    ImageEntity[] medAsteroids = new ImageEntity[5];
    ImageEntity[] smlAsteroids = new ImageEntity[5];
    ImageEntity[] tnyAsteroids = new ImageEntity[5];
    ...
    boolean keyB, keyC, keyUp, keyLeft, keyRight, keyFire, keyShield;
 ...
 *******************************************************************/
    private void resetGame(){
        ...
        sprites().add(ship);
        //create random asteroid sprites
 ...
 *******************************************************************/
    void gameRefreshScreen() {
        ...
        if (gameState == GAME_MENU) {
            ...
            g2d.drawString("SHIELD - Shift key (no scroring)", x+20,++y*20);
            g2d.drawString("FIRE - Space Bar", x+20,++y*20);
    ...
    public void spriteCollision(AnimatedSprite spr1, AnimatedSprite spr2) {
        ...
        case SPRITE_SHIP:
            ...
            if (isAsteroid(spr2.spriteType())) {
                ...
                //make ship temporaraly invulnerable
...
/*******************************************************************
 * spawn a smaller asteroid bassed on passed sprite
 *******************************************************************/
    private void spawnAsteroid(AnimatedSprite sprite) {
        ...
        ast.setAlive(true);
        //set position-random position around source sprite
 ...
 *******************************************************************/
    public void checkInput() {
        ...
        if (keyUp) {
            //up arrow applies thrust to the ship
            ...
            //set ship image normal non-thrust image
            ship.setImage(shipImage[0].getImage());
        if (keyFire) {
            bulletTime++;
            if (bulletTime == 10) {
 ...
 *******************************************************************/
    public void fireBullet() {
        ...
        AnimatedSprite[] bullets = new AnimatedSprite[360];
        ...
        case 5://5-shot
            ...
            break;
        case 6://bomb
            for (int x=0; x<359; x+=5){
                bullets[x] = stockBullet();
                adjustDirection(bullets[x], x);
                sprites().add(bullets[x]);
            }
            break;
        }
        //shoot.play();
 ...
 *******************************************************************/
    public void startSmallExplosion(Point2D point) {
        ...
        expl.setTotalFrames(25);
        expl.setColumns(5);
        expl.setFrameWidth(32);
        expl.setFrameHeight(32);
...
/*******************************************************************
 * cause sprite to wrap around the edges of the screen
 *******************************************************************/
    public void wrap(AnimatedSprite spr) {
